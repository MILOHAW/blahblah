...
# All island skin / theme IDs (covers all seasonal skin events 1-100)
...
def ensure_all_themes_owned(player_object):
    """Ensures all islands and player data have every island skin/theme unlocked, active, and owned."""
    player_object["owned_island_themes"] = ALL_THEME_IDS
    player_object["owned_themes"] = ALL_THEME_IDS
    player_object["unlocked_themes"] = ALL_THEME_IDS
    player_object["available_themes"] = ALL_THEME_IDS
    for island in player_object.get("islands") or []:
        if island is None:
            continue
        island["owned_themes"] = ALL_THEME_IDS
        island["unlocked_themes"] = ALL_THEME_IDS
        island["available_themes"] = ALL_THEME_IDS
        island["themes"] = ALL_THEME_IDS
        island["island_themes"] = ALL_THEME_IDS
...
def buy_island(username, params):
    ...
    new_island = {
        "eggs": [], "warp_speed": {"__double_bits": "0x3ff0000000000000"}, "island": island_id,
        ...
        "last_baked": [], "tiles": {}, "light_torch_flag": False, "monsters_sold": "[]",
        "date_created": now_ms, "costume_data": {"costumes": []}, "book_monster_ids": [],
        "owned_themes": ALL_THEME_IDS, "unlocked_themes": ALL_THEME_IDS, "available_themes": ALL_THEME_IDS,
        "themes": ALL_THEME_IDS, "island_themes": ALL_THEME_IDS, "owned": True, "unlocked": True,
        "locked": False, "island_unlocked": True, "island_owned": True,
    }
    if island_type == 9:
...
def update_island_mode(username, params):
    ...
    root, player_object = load_player(username)
    ensure_all_themes_owned(player_object)
...
def activate_island_theme(username, params):
    ...
    return {
        "success": True, "buy_and_activate_now": True,
        "island": full.get("island", 1), "user_island_theme_id": full.get("theme_id", 1),
        "trial": False,
        "owned_themes": ALL_THEME_IDS,
        "unlocked_themes": ALL_THEME_IDS,
        "available_themes": ALL_THEME_IDS,
...
def get_island_rank(username, params):
    ...
    theme = {
        ...
        "cost_diamonds": 0, "price": 0, "currency": "diamonds",
        "is_available": 1, "available": 1, "in_shop": 1
    }
    entry = {
    ...
    return {
        ...
        "active_island_theme": theme, "island_theme": theme,
        "theme_id": 1, "skin_id": 1, "cost_diamonds": 0, "price": 0, "currency": "diamonds",
        "owned_themes": ALL_THEME_IDS, "unlocked_themes": ALL_THEME_IDS, "available_themes": ALL_THEME_IDS,
    }
